...
class GuiMixin(object):
    ...
    def callback_PassphraseRequest(self, req):
        ...
        if length > 50:
            self.handler.show_error(_("Too long passphrase ({} > 50 chars).")
                                    .format(length))
            return self.proto.Cancel()
        return ack
...
class OctoClientBase(GuiMixin, PrintError):
    ...
    def get_xpub(self, bip32_path, xtype):
        ...
        node = self.get_public_node(address_n, False).node
    ...
    def clear_session(self):
        ...
        try:
            super(OctoClientBase, self).clear_session()
    ...
    def get_public_node(self, address_n, creating):
        ...
        return super(OctoClientBase, self).get_public_node(address_n)
